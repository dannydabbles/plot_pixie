...
def character_name_to_id(character_name):
    """
...
def save_dalle_image_to_s3(image_url, character_id, portrait_num):
    """
...
def generate_portrait(prompt, character_id, portrait_num):
    """
